# Generated by Django 4.1.7 on 2023-03-25 12:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.CharField(choices=[('0', 'Нет оценки'), ('1', 'Не советую'), ('2', 'На небольшой бюджет'), ('3', 'Можно пользоваться'), ('4', 'Лучший выбор'), ('5', 'Для мажоров')], default='0', max_length=1)),
